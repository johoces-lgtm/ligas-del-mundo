...
import cl.duoc.ligas.dto.DtoApiError;
...
public class LigasController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Operación exitosa", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoLigasResponse.class))),
        @ApiResponse(responseCode = "204", description = "No hay ligas registradas", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class))),
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "404", description = "La liga no existe", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class))),
        @ApiResponse(responseCode = "500", description = "Error interno del servidor", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class)))
    })
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "400", description = "Datos de entrada inválidos", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class))),
        @ApiResponse(responseCode = "500", description = "Error interno del servidor", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class)))
    })
    ...
    public ResponseEntity<DtoLigasResponse> actualizar(@PathVariable Long id, @Valid @RequestBody DtoLigasRequest request) {
        return ResponseEntity.ok(ligasService.actualizarLiga(id, request));
    }
