...
import cl.duoc.lesiones.dto.DtoApiError;
...
public class LesionesController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Historial médico recuperado con éxito", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoLesionesResponse.class))),
        @ApiResponse(responseCode = "204", description = "No hay registros de lesiones disponibles", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class))),
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Historial médico del deportista procesado correctamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoLesionesResponse.class))),
        @ApiResponse(responseCode = "204", description = "No hay registros de lesiones disponibles para el jugador", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class))),
        @ApiResponse(responseCode = "404", description = "El ID del jugador ingresado no existe en el ecosistema", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class))),
        @ApiResponse(responseCode = "500", description = "Error interno del servidor", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class)))
    })
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "404", description = "Imposible asociar lesión: El ID del futbolista no existe", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class))),
        @ApiResponse(responseCode = "400", description = "Fallo de validación estructural en el formato JSON", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class)))
    })
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "404", description = "El ID de la lesión no existe", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class))),
        @ApiResponse(responseCode = "500", description = "Error interno del servidor", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class)))
    })
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Eliminar un parte médico", description = "Borra completamente un registro de lesión del sistema utilizando su ID único")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "204", description = "Lesión eliminada correctamente"),
        @ApiResponse(responseCode = "404", description = "El ID de la lesión no existe", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class))),
        @ApiResponse(responseCode = "500", description = "Error interno del servidor", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DtoApiError.class)))
    })
